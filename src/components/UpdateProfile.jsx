            ...
            <Modal show={show} onHide={handleClose} backdrop="static" keyboard={false}  >
                ...
                <Modal.Body  >
                    ...
                    <div className='d-flex row'>
                        <Col sm={6}>
                            <label className=' d-flex justify-content-center align-items-center' style={{ flexDirection: "column" }}>
                                <input type="file" style={{ display: "none" }} onChange={(e) => { setEdit({ ...edit, image: e.target.files[0] }) }} />
                                <img src={imgPrev ? imgPrev : edit.image? `${base_url}/uploads/${edit.image}`:userimg } className='' width={"50%"} alt="" style={{ cursor: "pointer" }} />
                                Profile Image
                            </label>
                        </Col>
                        <Col sm={6}>
                            ...
                            <label className='mt-3 d-flex justify-content-center align-items-center' style={{ flexDirection: "column" }}>
                                ...
                                <img src={bacPrev ? bacPrev : edit.background? `${base_url}/uploads/${edit.background}` :"https://t4.ftcdn.net/jpg/04/81/13/43/360_F_481134373_0W4kg2yKeBRHNEklk4F9UXtGHdub3tYk.jpg" } width={"45%"} alt="" style={{ cursor: "pointer" }} />
                                Cover Image
                            </label>
                        </Col>
